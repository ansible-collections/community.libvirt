...
An Ansible collection (`community.libvirt`) providing modules, inventory plugins, and connection plugins for managing libvirt-based virtualization. It includes modules for managing virtual machines, networks, storage pools, volumes, secrets, and cloud instances, as well as inventory and connection plugins.

## Development Environment

The collection must reside at `ansible_collections/community/libvirt/` (relative to a directory on `ANSIBLE_COLLECTIONS_PATHS`) for imports to resolve correctly.
...
- Use conventional commit message prefixes: `feat:`, `fix:`, `docs:`, `test:`, `refactor:`, `chore:`, `ci:`. Example: `fix: handle missing domain in virt module`.
